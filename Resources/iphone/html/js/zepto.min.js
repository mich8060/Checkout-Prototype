var Zepto = function() {
    ...
    function S(a, b) {
        return "number" != typeof b || k[Q(a)] ? b : b + "px";
    }
    function T(a) {
        var b, c;
    ...
    var a, b, c, d, C, D, e = [], f = e.slice, g = e.filter, h = window.document, i = {}, j = {}, k = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        th: t,
        "*": h.createElement("div")
    }, v = /complete|loaded|interactive/, y = /^[\w-]*$/, z = {}, A = z.toString, B = {}, E = h.createElement("div"), F = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return B.matches = function(a, b) {
        ...
        return J(a) && h && d ? (c = a.getElementById(g)) ? [ c ] : [] : 1 !== a.nodeType && 9 !== a.nodeType ? [] : f.call(h && !d ? e ? a.getElementsByClassName(g) : a.getElementsByTagName(b) : a.querySelectorAll(b));
    ...
    c.isEmptyObject = function(a) {
        ...
        var c, e, f, d = [];
        if (N(a)) for (e = 0; a.length > e; e++) c = b(a[e], e), null != c && d.push(c); else for (f in a) c = b(a[f], f), 
        null != c && d.push(c);
        return P(d);
    }, c.each = function(a, b) {
        var c, d;
        ...
        not: function(b) {
            ...
            if (H(b) && b.call !== a) this.each(function(a) {
                ...
                var e = "string" == typeof b ? this.filter(b) : N(b) && H(b.item) ? f.call(b) : c(b);
        ...
        find: function(a) {
            ...
            }) : 1 == this.length ? c(B.qsa(this[0], a)) : this.map(function() {
                return B.qsa(this, a);
            }), b;
        },
        ...
        parents: function(a) {
            ...
            while (d.length > 0) d = c.map(d, function(a) {
                if ((a = a.parentNode) && !J(a) && 0 > b.indexOf(a)) return b.push(a), a;
            });
            return W(b, a);
        },
        parent: function(a) {
        ...
        css: function(a, d) {
            if (2 > arguments.length) {
                ...
                if (!e) return;
                if ("string" == typeof a) return e.style[C(a)] || f.getPropertyValue(a);
                if (M(a)) {
                    var g = {};
            ...
            var h = "";
            if ("string" == G(a)) d || 0 === d ? h = Q(a) + ":" + S(a, d) : this.each(function() {
                this.style.removeProperty(Q(a));
            }); else for (b in a) a[b] || 0 === a[b] ? h += Q(b) + ":" + S(b, a[b]) + ";" : this.each(function() {
        ...
        c.fn[a] = function() {
            var a, f, e = c.map(arguments, function(b) {
                return a = G(b), "object" == a || "array" == a || null == b ? b : B.fragment(b);
            }), g = this.length > 1;
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(a) {
    ...
    function y(b, c) {
        if (c || !b.isDefaultPrevented) {
            ...
            (c.defaultPrevented !== d ? c.defaultPrevented : "returnValue" in c ? c.returnValue === !1 : c.getPreventDefault && c.getPreventDefault()) && (b.isDefaultPrevented = u);
        }
        return b;
    }
    function z(a) {
    ...
    function ajaxSuccess(a, b, c, d) {
        ...
        c.success.call(e, a, f, b), d && d.resolveWith(e, [ a, f, b ]), triggerGlobal(c, e, "ajaxSuccess", [ b, c, a ]), 
        ajaxComplete(f, b, c);
    }
    function ajaxError(a, b, c, d, e) {
        var f = d.context;
        d.error.call(f, c, b, a), e && e.rejectWith(f, [ c, b, a ]), triggerGlobal(d, f, "ajaxError", [ c, d, a || b ]), 
        ajaxComplete(b, c, d);
    }
    ...
    function serialize(a, b, c, d) {
        ...
        $.each(b, function(b, h) {
            e = $.type(h), d && (b = c ? d : d + "[" + (g || "object" == e || "array" == e ? b : "") + "]"), 
            !d && f ? a.add(h.name, h.value) : "array" == e || !c && "object" == e ? serialize(a, h, c, b) : a.add(b, h);
        });
    }
    ...
    $.active = 0, $.ajaxJSONP = function(a, b) {
        if ("type" in a) {
            var g, j, c = a.jsonpCallback, d = ($.isFunction(c) ? c() : c) || "jsonp" + ++jsonpID, e = document.createElement("script"), f = window[d], h = function(a) {
                $(e).triggerHandler("error", a || "abort");
            }, i = {
                abort: h
            };
            return b && b.promise(i), $(e).on("load error", function(c, h) {
                clearTimeout(j), $(e).off().remove(), "error" != c.type && g ? ajaxSuccess(g[0], i, a, b) : ajaxError(null, h || "error", i, a, b), 
                window[d] = f, g && $.isFunction(f) && f(g[0]), f = g = void 0;
        ...
        var abortTimeout, mime = settings.accepts[dataType], headers = {}, setHeader = function(a, b) {
        ...
        deferred && deferred.promise(xhr), settings.crossDomain || setHeader("X-Requested-With", "XMLHttpRequest"), 
        setHeader("Accept", mime || "*/*");
        (mime = settings.mimeType || mime) && (mime.indexOf(",") > -1 && (mime = mime.split(",", 2)[0]), 
        ...
        if (ajaxBeforeSend(xhr, settings) === !1) return xhr.abort(), ajaxError(null, "abort", xhr, settings, deferred), 
        xhr;
